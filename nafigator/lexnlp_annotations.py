    ...
    if doc.language == "en":
        for annotation in annotations:
            ...
            if annotation == "condition":
                add_annotations(doc, lexnlp.extract.en.citations.get_citation_annotations)
            if annotation == "citation":
                add_annotations(doc, lexnlp.extract.en.conditions.get_condition_annotations)
            if annotation == "constraint":
                add_annotations(doc, lexnlp.extract.en.constraints.get_constraint_annotations)
            if annotation == "copyright":
                add_annotations(doc, lexnlp.extract.en.copyright.get_copyright_annotations)
            if annotation == "court":
            ...
            if annotation == "definition":
                add_annotations(doc, lexnlp.extract.en.definitions.get_definition_annotations)
            if annotation == "distance":
                add_annotations(doc, lexnlp.extract.en.distances.get_distance_annotations)
            if annotation == "duration":
                add_annotations(doc, lexnlp.extract.en.durations.get_duration_annotations)
            if annotation == "geoentities":
                add_annotations(doc, lexnlp.extract.en.geoentities.get_geoentities_annotations)
            if annotation == "money":
                add_annotations(doc, lexnlp.extract.en.money.get_money_annotations)
            if annotation == "percents":
                add_annotations(doc, lexnlp.extract.en.percents.get_percents_annotations)
            if annotation == "pii":
            ...
            if annotation == "regulations":
                add_annotations(doc, lexnlp.extract.en.regulations.get_regulation_annotations)
            if annotation == "trademarks":
                add_annotations(doc, lexnlp.extract.en.trademarks.get_trademark_annotations)
            if annotation == "urls":
