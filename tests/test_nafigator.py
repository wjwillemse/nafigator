...
class TestNafigator_pdf(unittest.TestCase):
    ...
    def test_2_header_filedesc(self):
        """ """
    ...
    # def test_4_header_linguistic_processors(self):
    #     naf = NafDocument().open(join("tests", "tests", "example.naf.xml"))
...
class TestNafigator_docx(unittest.TestCase):
    ...
    def test_7_text(self):
        naf = NafDocument().open(join("tests", "tests", "example.docx.naf.xml"))
        actual = naf.text
        expected = [{'text': 'The', 'id': 'w1', 'sent': '1', 'para': '1', 'page': '1', 'offset': '0', 'length': '3'}, 
        {'text': 'Nafigator', 'id': 'w2', 'sent': '1', 'para': '1', 'page': '1', 'offset': '4', 'length': '9'}, 
        {'text': 'package', 'id': 'w3', 'sent': '1', 'para': '1', 'page': '1', 'offset': '14', 'length': '7'}, 
        {'text': 'allows', 'id': 'w4', 'sent': '1', 'para': '1', 'page': '1', 'offset': '22', 'length': '6'},
        {'text': 'you', 'id': 'w5', 'sent': '1', 'para': '1', 'page': '1', 'offset': '29', 'length': '3'}, 
        {'text': 'to', 'id': 'w6', 'sent': '1', 'para': '1', 'page': '1', 'offset': '33', 'length': '2'}, 
        {'text': 'store', 'id': 'w7', 'sent': '1', 'para': '1', 'page': '1', 'offset': '36', 'length': '5'}, 
        {'text': 'NLP', 'id': 'w8', 'sent': '1', 'para': '1', 'page': '1', 'offset': '42', 'length': '3'}, 
        {'text': 'output', 'id': 'w9', 'sent': '1', 'para': '1', 'page': '1', 'offset': '46', 'length': '6'}, 
        {'text': 'from', 'id': 'w10', 'sent': '1', 'para': '1', 'page': '1', 'offset': '53', 'length': '4'}, 
        {'text': 'custom', 'id': 'w11', 'sent': '1', 'para': '1', 'page': '1', 'offset': '58', 'length': '6'}, 
        {'text': 'made', 'id': 'w12', 'sent': '1', 'para': '1', 'page': '1', 'offset': '65', 'length': '4'}, 
        {'text': 'Spacy', 'id': 'w13', 'sent': '1', 'para': '1', 'page': '1', 'offset': '70', 'length': '5'}, 
        {'text': 'and', 'id': 'w14', 'sent': '1', 'para': '1', 'page': '1', 'offset': '76', 'length': '3'}, 
        {'text': 'stanza', 'id': 'w15', 'sent': '1', 'para': '1', 'page': '1', 'offset': '80', 'length': '6'}, 
        {'text': 'pipelines', 'id': 'w16', 'sent': '1', 'para': '1', 'page': '1', 'offset': '87', 'length': '9'}, 
        {'text': 'with', 'id': 'w17', 'sent': '1', 'para': '1', 'page': '1', 'offset': '97', 'length': '4'}, 
        {'text': '(', 'id': 'w18', 'sent': '1', 'para': '1', 'page': '1', 'offset': '102', 'length': '1'}, 
        {'text': 'intermediate', 'id': 'w19', 'sent': '1', 'para': '1', 'page': '1', 'offset': '103', 'length': '12'}, 
        {'text': ')', 'id': 'w20', 'sent': '1', 'para': '1', 'page': '1', 'offset': '115', 'length': '1'}, 
        {'text': 'results', 'id': 'w21', 'sent': '1', 'para': '1', 'page': '1', 'offset': '117', 'length': '7'}, 
        {'text': 'and', 'id': 'w22', 'sent': '1', 'para': '1', 'page': '1', 'offset': '125', 'length': '3'}, 
        {'text': 'all', 'id': 'w23', 'sent': '1', 'para': '1', 'page': '1', 'offset': '129', 'length': '3'}, 
        {'text': 'processing', 'id': 'w24', 'sent': '1', 'para': '1', 'page': '1', 'offset': '133', 'length': '10'}, 
        {'text': 'steps', 'id': 'w25', 'sent': '1', 'para': '1', 'page': '1', 'offset': '144', 'length': '5'}, 
        {'text': 'in', 'id': 'w26', 'sent': '1', 'para': '1', 'page': '1', 'offset': '150', 'length': '2'}, 
        {'text': 'one', 'id': 'w27', 'sent': '1', 'para': '1', 'page': '1', 'offset': '153', 'length': '3'}, 
        {'text': 'format', 'id': 'w28', 'sent': '1', 'para': '1', 'page': '1', 'offset': '157', 'length': '6'}, 
        {'text': '.', 'id': 'w29', 'sent': '1', 'para': '1', 'page': '1', 'offset': '163', 'length': '1'},
        {'text': 'Multiwords', 'id': 'w30', 'sent': '2', 'para': '1', 'page': '1', 'offset': '166', 'length': '10'}, 
        {'text': 'like', 'id': 'w31', 'sent': '2', 'para': '2', 'page': '1', 'offset': '177', 'length': '4'},
        {'text': 'in', 'id': 'w32', 'sent': '2', 'para': '2', 'page': '1', 'offset': '182', 'length': '2'}, 
        {'text': '“', 'id': 'w33', 'sent': '2', 'para': '2', 'page': '1', 'offset': '185', 'length': '1'}, 
        {'text': 'we', 'id': 'w34', 'sent': '2', 'para': '2', 'page': '1', 'offset': '186', 'length': '2'}, 
        {'text': 'have', 'id': 'w35', 'sent': '2', 'para': '2', 'page': '1', 'offset': '189', 'length': '4'}, 
        {'text': 'set', 'id': 'w36', 'sent': '2', 'para': '2', 'page': '1', 'offset': '194', 'length': '3'}, 
        {'text': 'that', 'id': 'w37', 'sent': '2', 'para': '2', 'page': '1', 'offset': '198', 'length': '4'},
        {'text': 'out', 'id': 'w38', 'sent': '2', 'para': '2', 'page': '1', 'offset': '203', 'length': '3'},
        {'text': 'below', 'id': 'w39', 'sent': '2', 'para': '2', 'page': '1', 'offset': '207', 'length': '5'}, 
        {'text': '”', 'id': 'w40', 'sent': '2', 'para': '2', 'page': '1', 'offset': '212', 'length': '1'}, 
        {'text': 'are', 'id': 'w41', 'sent': '2', 'para': '2', 'page': '1', 'offset': '214', 'length': '3'}, 
        {'text': 'recognized', 'id': 'w42', 'sent': '2', 'para': '2', 'page': '1', 'offset': '218', 'length': '10'},
        {'text': '(', 'id': 'w43', 'sent': '2', 'para': '2', 'page': '1', 'offset': '229', 'length': '1'}, 
        {'text': 'depending', 'id': 'w44', 'sent': '2', 'para': '2', 'page': '1', 'offset': '230', 'length': '9'},
        {'text': 'on', 'id': 'w45', 'sent': '2', 'para': '2', 'page': '1', 'offset': '240', 'length': '2'},
        {'text': 'your', 'id': 'w46', 'sent': '2', 'para': '2', 'page': '1', 'offset': '243', 'length': '4'}, 
        {'text': 'NLP', 'id': 'w47', 'sent': '2', 'para': '2', 'page': '1', 'offset': '248', 'length': '3'}, 
        {'text': 'processor', 'id': 'w48', 'sent': '2', 'para': '2', 'page': '1', 'offset': '252', 'length': '9'},
        {'text': ')', 'id': 'w49', 'sent': '2', 'para': '2', 'page': '1', 'offset': '261', 'length': '1'}, 
        {'text': '.', 'id': 'w50', 'sent': '2', 'para': '2', 'page': '1', 'offset': '262', 'length': '1'}]
    ...
    def test_8_terms(self):
        naf = NafDocument().open(join("tests", "tests", "example.docx.naf.xml"))
        actual = naf.terms
        expected = [{'id': 't1', 'type': 'open', 'lemma': 'the', 'pos': 'DET', 'morphofeat': 'Definite=Def|PronType=Art', 'span': [{'id': 'w1'}]}, 
                    {'id': 't2', 'type': 'open', 'lemma': 'Nafigator', 'pos': 'PROPN', 'morphofeat': 'Number=Sing', 'span': [{'id': 'w2'}]}, 
                    {'id': 't3', 'type': 'open', 'lemma': 'package', 'pos': 'NOUN', 'morphofeat': 'Number=Sing', 'span': [{'id': 'w3'}]}, 
                    {'id': 't4', 'type': 'open', 'lemma': 'allow', 'pos': 'VERB', 'morphofeat': 'Mood=Ind|Number=Sing|Person=3|Tense=Pres|VerbForm=Fin', 'span': [{'id': 'w4'}]}, 
                    {'id': 't5', 'type': 'open', 'lemma': 'you', 'pos': 'PRON', 'morphofeat': 'Case=Acc|Person=2|PronType=Prs', 'span': [{'id': 'w5'}]}, 
                    {'id': 't6', 'type': 'open', 'lemma': 'to', 'pos': 'PART', 'span': [{'id': 'w6'}]}, 
                    {'id': 't7', 'type': 'open', 'lemma': 'store', 'pos': 'VERB', 'morphofeat': 'VerbForm=Inf', 'span': [{'id': 'w7'}]}, 
                    {'id': 't8', 'type': 'open', 'lemma': 'nlp', 'pos': 'NOUN', 'morphofeat': 'Number=Sing', 'span': [{'id': 'w8'}]}, 
                    {'id': 't9', 'type': 'open', 'lemma': 'output', 'pos': 'NOUN', 'morphofeat': 'Number=Sing', 'span': [{'id': 'w9'}]}, 
                    {'id': 't10', 'type': 'open', 'lemma': 'from', 'pos': 'ADP', 'span': [{'id': 'w10'}]}, 
                    {'id': 't11', 'type': 'open', 'lemma': 'custom', 'pos': 'NOUN', 'morphofeat': 'Number=Sing', 'span': [{'id': 'w11'}]}, 
                    {'id': 't12', 'type': 'open', 'lemma': 'make', 'pos': 'VERB', 'morphofeat': 'Tense=Past|VerbForm=Part', 'span': [{'id': 'w12'}]}, 
                    {'id': 't13', 'type': 'open', 'lemma': 'spacy', 'pos': 'NOUN', 'morphofeat': 'Number=Sing', 'span': [{'id': 'w13'}]}, 
                    {'id': 't14', 'type': 'open', 'lemma': 'and', 'pos': 'CCONJ', 'span': [{'id': 'w14'}]}, 
                    {'id': 't15', 'type': 'open', 'lemma': 'stanza', 'pos': 'NOUN', 'morphofeat': 'Number=Sing', 'span': [{'id': 'w15'}]}, 
                    {'id': 't16', 'type': 'open', 'lemma': 'pipeline', 'pos': 'NOUN', 'morphofeat': 'Number=Plur', 'span': [{'id': 'w16'}]}, 
                    {'id': 't17', 'type': 'open', 'lemma': 'with', 'pos': 'ADP', 'span': [{'id': 'w17'}]}, 
                    {'id': 't18', 'type': 'open', 'lemma': '(', 'pos': 'PUNCT', 'span': [{'id': 'w18'}]}, 
                    {'id': 't19', 'type': 'open', 'lemma': 'intermediate', 'pos': 'ADJ', 'morphofeat': 'Degree=Pos', 'span': [{'id': 'w19'}]}, 
                    {'id': 't20', 'type': 'open', 'lemma': ')', 'pos': 'PUNCT', 'span': [{'id': 'w20'}]}, 
                    {'id': 't21', 'type': 'open', 'lemma': 'result', 'pos': 'NOUN', 'morphofeat': 'Number=Plur', 'span': [{'id': 'w21'}]}, 
                    {'id': 't22', 'type': 'open', 'lemma': 'and', 'pos': 'CCONJ', 'span': [{'id': 'w22'}]}, 
                    {'id': 't23', 'type': 'open', 'lemma': 'all', 'pos': 'DET', 'span': [{'id': 'w23'}]},
                    {'id': 't24', 'type': 'open', 'lemma': 'processing', 'pos': 'NOUN', 'morphofeat': 'Number=Sing', 'span': [{'id': 'w24'}]}, 
                    {'id': 't25', 'type': 'open', 'lemma': 'step', 'pos': 'NOUN', 'morphofeat': 'Number=Plur', 'span': [{'id': 'w25'}]}, 
                    {'id': 't26', 'type': 'open', 'lemma': 'in', 'pos': 'ADP', 'span': [{'id': 'w26'}]},
                    {'id': 't27', 'type': 'open', 'lemma': 'one', 'pos': 'NUM', 'morphofeat': 'NumType=Card', 'span': [{'id': 'w27'}]}, 
                    {'id': 't28', 'type': 'open', 'lemma': 'format', 'pos': 'NOUN', 'morphofeat': 'Number=Sing', 'span': [{'id': 'w28'}]}, 
                    {'id': 't29', 'type': 'open', 'lemma': '.', 'pos': 'PUNCT', 'span': [{'id': 'w29'}]}, 
                    {'id': 't30', 'type': 'open', 'lemma': 'multiword', 'pos': 'NOUN', 'morphofeat': 'Number=Plur', 'span': [{'id': 'w30'}]}, 
                    {'id': 't31', 'type': 'open', 'lemma': 'like', 'pos': 'ADP', 'span': [{'id': 'w31'}]}, 
                    {'id': 't32', 'type': 'open', 'lemma': 'in', 'pos': 'ADP', 'span': [{'id': 'w32'}]}, 
                    {'id': 't33', 'type': 'open', 'lemma': '"', 'pos': 'PUNCT', 'span': [{'id': 'w33'}]},
                    {'id': 't34', 'type': 'open', 'lemma': 'we', 'pos': 'PRON', 'morphofeat': 'Case=Nom|Number=Plur|Person=1|PronType=Prs', 'span': [{'id': 'w34'}]},
                    {'id': 't35', 'type': 'open', 'lemma': 'have', 'pos': 'AUX', 'morphofeat': 'Mood=Ind|Tense=Pres|VerbForm=Fin', 'span': [{'id': 'w35'}]}, 
                    {'id': 't36', 'type': 'open', 'lemma': 'set', 'pos': 'VERB', 'morphofeat': 'Tense=Past|VerbForm=Part', 'component_of': 'mw1', 'span': [{'id': 'w36'}]},
                    {'id': 't37', 'type': 'open', 'lemma': 'that', 'pos': 'SCONJ', 'span': [{'id': 'w37'}]}, 
                    {'id': 't38', 'type': 'open', 'lemma': 'out', 'pos': 'ADP', 'component_of': 'mw1', 'span': [{'id': 'w38'}]}, 
                    {'id': 't39', 'type': 'open', 'lemma': 'below', 'pos': 'ADV', 'span': [{'id': 'w39'}]}, 
                    {'id': 't40', 'type': 'open', 'lemma': '"', 'pos': 'PUNCT', 'span': [{'id': 'w40'}]},
                    {'id': 't41', 'type': 'open', 'lemma': 'be', 'pos': 'AUX', 'morphofeat': 'Mood=Ind|Tense=Pres|VerbForm=Fin', 'span': [{'id': 'w41'}]}, 
                    {'id': 't42', 'type': 'open', 'lemma': 'recognize', 'pos': 'VERB', 'morphofeat': 'Tense=Past|VerbForm=Part|Voice=Pass', 'span': [{'id': 'w42'}]}, 
                    {'id': 't43', 'type': 'open', 'lemma': '(', 'pos': 'PUNCT', 'span': [{'id': 'w43'}]}, 
                    {'id': 't44', 'type': 'open', 'lemma': 'depend', 'pos': 'VERB', 'morphofeat': 'VerbForm=Ger', 'span': [{'id': 'w44'}]}, 
                    {'id': 't45', 'type': 'open', 'lemma': 'on', 'pos': 'ADP', 'span': [{'id': 'w45'}]}, 
                    {'id': 't46', 'type': 'open', 'lemma': 'you', 'pos': 'PRON', 'morphofeat': 'Person=2|Poss=Yes|PronType=Prs', 'span': [{'id': 'w46'}]}, 
                    {'id': 't47', 'type': 'open', 'lemma': 'nlp', 'pos': 'NOUN', 'morphofeat': 'Number=Sing', 'span': [{'id': 'w47'}]}, 
                    {'id': 't48', 'type': 'open', 'lemma': 'processor', 'pos': 'NOUN', 'morphofeat': 'Number=Sing', 'span': [{'id': 'w48'}]}, 
                    {'id': 't49', 'type': 'open', 'lemma': ')', 'pos': 'PUNCT', 'span': [{'id': 'w49'}]},
                    {'id': 't50', 'type': 'open', 'lemma': '.', 'pos': 'PUNCT', 'span': [{'id': 'w50'}]}]
        assert actual == expected, "expected: "+str(expected)+", actual: "+str(actual)
