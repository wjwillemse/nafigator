...
from nafigator.postprocessor import TableFormatter
import pandas as pd
import numpy as np
...
class TestTableFormatter(unittest.TestCase):
    ...
    def test_1_xml2table(self):
        ...
        exp_output_dict = [({0: [None, 'Kolom 1', 'Kolom 2'],
                           ...
                           2: ['Rij', 'Volgende cell is leeg', None]},
                            {'page': '1', 'order': '1', 'shape': '(3, 3)', '_bbox': '(71.98548972188634, 463.68, 439.351438935913, 686.64)',
                            'cols': '[(72.21044437726724, 194.6007738814994), (194.6007738814994, 316.7361547762999), (316.7361547762999, 439.2314631197098)]'})]
    ...
    def test_2_xml2table(self):
        ...
        exp_output_dict = [({0: [None, None, None, None],
                            ...
                            {'page': '1', 'order': '1', 'shape': '(6, 4)',
                             ...
                             'cols': '[(72.22356673216446, 163.88696493349457), (163.88696493349457, 255.7884401451028), (255.7884401451028, 347.4499637243047), (347.4499637243047, 439.2314631197098)]'})]
        ...
        exp_output_dict = [
            (
                ...
                {'page': '1', 'order': '1', 'shape': '(4, 3)',
                 ...
                 'cols': '[(72.21794286577993, 194.6007738814994), (194.6007738814994, 316.7361547762999), (316.7361547762999, 439.2314631197098)]'}),
            ({0: ['Rij 4', 'Zevende cell', 'Achtste cell'],
             ...
             {'page': '2', 'order': '1', 'shape': '(2, 3)',
              ...
              'cols': '[(72.19544740024185, 194.6007738814994), (194.6007738814994, 316.7361547762999), (316.7361547762999, 439.2314631197098)]'})]
    ...
    def test1_is_joint_table(self):
        ...
        metadata_table1_t = ({0: [None, 'Kolom 1', 'Kolom 2'], 1: ['Rij 1', 'Eerste cell', 'Tweede cell'], 2: ['Rij 2', 'Derde cell', 'Vierde cell'], 3: ['Rij 3', 'Vijfde cell', 'Zesde cell']}, {'page': '1', 'order': '1',
                             'shape': '(4, 3)', '_bbox': '(71.98548972188634, 154.56, 439.351438935913, 731.52)', 'cols': '[(72.21794286577993, 194.6007738814994), (194.6007738814994, 316.7361547762999), (316.7361547762999, 439.2314631197098)]'})
        metadata_table2_t = ({0: ['Rij 4', 'Zevende cell', 'Achtste cell'], 1: ['Rij 5', 'Negende cell', 'Tiende cell']}, {'page': '2', 'order': '1', 'shape': '(2, 3)',
                             '_bbox': '(71.98548972188634, 394.8, 439.351438935913, 714.24)', 'cols': '[(72.19544740024185, 194.6007738814994), (194.6007738814994, 316.7361547762999), (316.7361547762999, 439.2314631197098)]'})
    ...
    def test2_is_joint_table(self):
        ...
        # test where tables are joint
        metadata_table1_f = ({0: ['T       1 Rij 1', 'T1 cell 1', 'T1 cell 1', 'T1 cell 1'], 1: ['T                 1 Rij 2', 'T1 cell 1', 'T1 cell 1', 'T1 cell 1'], 2: ['T         1 Rij 3', 'T1 cell 1', 'T1 cell 1', 'T1 cell 1']}, {'page': '1', 'order': '1',
                             'shape': '(3, 4)', '_bbox': '(71.98548972188634, 72.96, 523.3345102781137, 545.04)', 'cols': '[(72.21044437726724, 185.0027085852479), (185.0027085852479, 297.5400241837969), (297.5400241837969, 410.31729141475216), (410.31729141475216, 523.2145344619105)]'})
        metadata_table2_f = ({0: ['T       2 Rij 1', 'T2 Cell 1', 'T2 Cell 2', None], 1: ['T                   2 Rij 2', 'T2 Cell 3', 'T2 Cell 4', None]}, {'page': '2', 'order': '1', 'shape': '(2, 4)',
                             '_bbox': '(71.98548972188634, 423.59999999999997, 523.3345102781137, 747.36)', 'cols': '[(72.19544740024185, 135.8126239419589), (135.8126239419589, 297.5400241837969), (297.5400241837969, 490.22118500604597), (490.22118500604597, 523.2145344619105)]'})
    ...
    def test_join_split_tables(self):
        ...
        exp_output = pd.DataFrame({0: {0: None, 1: 'Kolom 1', 2: 'Kolom 2', 3: 'Rij 4', 4: 'Zevende cell', 5: 'Achtste cell'},
                                  1: {0: 'Rij 1', 1: 'Eerste cell', 2: 'Tweede cell', 3: 'Rij 5', 4: 'Negende cell', 5: 'Tiende cell'},
        ...
        exp_output_h = {None: {1: 'Kolom 1', 2: 'Kolom 2', 3: 'Rij 4', 4: 'Zevende cell', 5: 'Achtste cell'}, 'Rij 1': {1: 'Eerste cell', 2: 'Tweede cell', 3: 'Rij 5', 4: 'Negende cell',
                                                                                                                        5: 'Tiende cell'}, 'Rij 2': {1: 'Derde cell', 2: 'Vierde cell', 3: np.nan, 4: np.nan, 5: np.nan}, 'Rij 3': {1: 'Vijfde cell', 2: 'Zesde cell', 3: np.nan, 4: np.nan, 5: np.nan}}
