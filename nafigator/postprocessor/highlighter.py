...
# @TODO: This Highlighter was written for the formats_copy.
# formats_copy needs more development.

# class Highlighter:
#     def __init__(self, path_input_pdf: str, doc: NafDocument) -> None:
#         """
#         Initialize the Highlighter. this highlighter makes use of the formats_copy layer.
